    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="mb-16 flex flex-col gap-y-7 empty:hidden">
          ...
          >
            ...
            <AuiIf condition={(s) => isNewChatView(s)}>
              <p className="text-center text-[11px] text-[var(--muted-soft)]">
                Responses are generated by the model you select. Check important
                info.
              </p>
            </AuiIf>
          </ThreadPrimitive.ViewportFooter>
...
const Composer: FC = () => {
  ...
  return (
    <ComposerPrimitive.Root className="relative flex w-full flex-col">
      ...
      <div className="flex w-full flex-col gap-2 rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-2 transition-[border-color] focus-within:border-[rgba(120,100,75,0.28)]">
...
const MessageError: FC = () => {
  return (
    <MessagePrimitive.Error>
      <ErrorPrimitive.Root className="mt-2 rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-800">
  ...
  return (
    ...
    >
      <div className="relative max-w-[85%] sm:max-w-[80%]">
        <div className="rounded-[1.25rem] rounded-br-md bg-[var(--elevated)] px-4 py-2.5 text-[15px] leading-relaxed text-[var(--text)] wrap-break-word">
          <MessagePrimitive.Parts />
        </div>
