...
UI (Playwright against the wired chrome): blank **Howzit?** after send, duplicate Working strips, raw DSML visible, “Application error” client exception, stuck Stop, missing **Worked for Ns**, vanished Working with an empty transcript, “This step failed” without recovery. Failures write a PNG under `evals/probe/artifacts/`.
